                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="nomor_surat" class="form-control" placeholder="Nomor Surat"
                                    name="nomor_surat" value="{{ $suratMasuk->nomor_surat }}" required>
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                <input type="date" id="tanggal_masuk" class="form-control" name="tanggal_masuk"
                                    value="{{ $suratMasuk->tanggal_masuk }}" required>
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                <textarea id="isi_ringkasan" class="form-control" placeholder="Isi Ringkasan" name="isi_ringkasan" rows="4"
                                    required>{{ $suratMasuk->isi_ringkasan }}</textarea>
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                <textarea id="keterangan" class="form-control" placeholder="Keterangan (Opsional)" name="keterangan" rows="3">{{ $suratMasuk->keterangan }}</textarea>
                            </div>
                            ...
                            <div class="col-md-8 form-group">
                                <textarea id="alamat" class="form-control" placeholder="Alamat" name="alamat" rows="3" required>{{ $suratMasuk->alamat }}</textarea>
                            </div>
