            ...
            class h {
                ...
                filter(t, e, s, i) {
                    ...
                    const n = a.filterState[t](),
                        r = Array.from(a.filterState.originalData).filter(
                            (e) => {
                                const s = e.cells[t],
                ...
                sort(t, s, i) {
                    ...
                    if (n && 0 !== n.length)
                        return void this.filter(t, s, i, n);
                    (a.sorting = !0), i || a.emit("datatable.sorting", t, s);
                    let o = a.data;
                    const h = [],
                        l = [];
                    let d = 0,
                    ...
                    if ("date" === p.getAttribute("data-type")) {
                        let t = !1;
                        p.hasAttribute("data-format") &&
                            (t = p.getAttribute("data-format")),
                            u.push(
                                e.import("./date-ac7cc82e.js").then(
                                    ({ parseDate: e }) =>
                                        (s) =>
                                            e(s, t)
                                )
                        ...
                        Array.from(o).forEach((e) => {
                            ...
                            "desc" == s
                                ? ((u = r(h, -1)),
                                  ...
                                  p.setAttribute("aria-sort", "descending"))
                                : ((u = r(l, 1)),
                                  (g = r(h, 1)),
                                  p.classList.remove("desc"),
                                  p.classList.add("asc"),
                                  p.setAttribute("aria-sort", "ascending")),
                            a.lastTh &&
                                p != a.lastTh &&
            ...
            t(
                ...
                class {
                    constructor(t, e = {}) {
                        ...
                        if (
                            ((this.options = {
                                ...
                                labels: { ...d.labels, ...e.labels },
                            }),
                            (this.rows = new o(this)),
                            (this.columns = new h(this)),
                            (this.initialized = !1),
                    ...
                    render() {
                        ...
                        const e = i("nav", { class: "dataTable-pagination" }),
                            s = i("ul", { class: "dataTable-pagination-list" });
                        e.appendChild(s),
                            ...
                            (this.label =
                                this.wrapper.querySelector(".dataTable-info")),
                    ...
                    renderPager() {
                        if ((a(this.pagers), this.totalPages > 1)) {
                            const t = "pager",
                                e = document.createDocumentFragment(),
                            ...
                            this.options.firstLast &&
                                e.appendChild(n(t, 1, this.options.firstText)),
                                this.options.nextPrev &&
                                    !this.onFirstPage &&
                                    e.appendChild(
                                        n(t, s, this.options.prevText)
                                    );
                            let r = this.links;
                            this.options.truncatePager &&
                                ...
                                this.links[this.currentPage - 1].classList.add(
                                    "active"
                                ),
                                r.forEach((t) => {
                    ...
                    bindEvents() {
                        ...
                        this.options.searchable &&
                            ((this.input =
                                this.wrapper.querySelector(".dataTable-input")),
                            this.input &&
                    ...
                    fixColumns() {
                        if (
                            ...
                            if (((this.columnWidths = []), this.dom.tHead)) {
                                ...
                                if (
                                    (this.activeHeadings.forEach((s, a) => {
                                    ...
                                    this.dom.replaceChild(e, s),
                                        ...
                                        (this.headerTable.parentElement.style.paddingRight = `${
                                            ...
                                            parseInt(
                                                this.headerTable.parentElement
                    ...
                    import(t) {
                        ...
                        if (i.data.length || s(i.data)) {
                            ...
                            s(i.data) && (e = i.data), e && this.insert(e);
                        }
                        return !1;
                    }
                    print() {
                        const t = this.activeHeadings,
                            ...
                            r = i("tr");
                        t.forEach((t) => {
                            r.appendChild(i("th", { html: t.textContent }));
                        }),
                            a.appendChild(r),
                            e.forEach((t) => {
                                const e = i("tr");
