    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <!--FORM-->
                <form action="{{ route('profile.update', $pengguna->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <!-- Foto -->
                            <img src="{{ $pengguna->gambar_profile ? asset('storage/profile/' . $pengguna->gambar_profile) : asset('assets/compiled/jpg/1.jpg') }}"
                            ...
                            <div class="button-wrapper">
                                ...
                                <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                    ...
                                    <input type="file" id="upload" class="account-file-input" hidden
                                        accept="image/png, image/jpeg, image/jpg," name="gambar_profile" />
                                </label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const defaultAvatarSrc =
                "{{ $pengguna->gambar_profile ? asset('storage/profile/'.$pengguna->gambar_profile) : asset('assets/compiled/jpg/1.jpg') }}";
